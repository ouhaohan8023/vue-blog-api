...
@endcan
                     ...
                     @can("admin.op-log.")
                    <li>
                    <a @if(Route::currentRouteName() == "admin.op-log.") class="active" @endif href="/admin/op-log">
                    <i class="fa fa-eye"></i>
                    <span>@lang("rrm::permission.admin.op-log.")</span>
                    </a>
                    </li>
                    @endcan
                     ...
                     @can("admin.novels.")
                    <li>
                    <a @if(Route::currentRouteName() == "admin.novels.") class="active" @endif href="/admin/novels">
                    <i class="fa fa-file"></i>
                    <span>@lang("rrm::permission.admin.novels.")</span>
                    </a>
                    </li>
                    @endcan
